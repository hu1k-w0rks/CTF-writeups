...
A. In the Detection tab of VirusTotal, check for Threat categories name - ( Trojan )
...
A. In the Details tab of VirusTotal, navigate to Names section - ( Wextract )
...
A. In the Details tab of VirusTotal, navigate to History -> First Submission - ( 2023-10-06 04:41 )
...
A. In the Behavior tab of VirusTotal, navigate to MITRE ATT&CK Tactics and Techniques, search for collection - ( T1005 )
...
A. In the Relations tab of VirusTotal, Navigate to contacted domains and search for different social media websites. Only facebook is found - ( facebook.com )
...
A. In the Behavior tab of VirusTotal, under network communication section navigate to IP traffic. - ( 77.91.124.55:19071 )
